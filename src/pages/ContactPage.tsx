...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitStatus(isNetworkError ? 'network_error' : 'error');
            ...
            <div className="glass-card p-8 rounded-2xl">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-red-300 text-sm">
                      Please try again or contact us directly via email or WhatsApp.
                    </p>
                  </div>
                </motion.div>
              )}
              ...
              {submitStatus === 'network_error' && (
                <motion.div
                  initial={{ opacity: 0, y: -20 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="mb-6 p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/30 flex items-start space-x-3"
                >
                  <AlertCircle className="w-5 h-5 text-yellow-400 flex-shrink-0 mt-0.5" />
                  <div className="flex-1">
                    <p className="text-yellow-400 font-medium mb-1">Connection Error</p>
              ...
              <p className="mt-6 text-sm text-gray-400 text-center">
                By submitting this form, you agree to our <a href="/privacy" className="text-primary-400 hover:underline">privacy policy</a> and <a href="/terms" className="text-primary-400 hover:underline">terms of service</a>.
              </p>
            </div>
          </motion.div>
        </div>
