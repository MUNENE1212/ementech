 ...
 * EmailList Component
 *
 * Displays a scrollable list of emails with real-time updates,
...
const EmailList = ({
  ...
  useEffect(() => {
    ...
    if (folder && folder !== 'ALL') {
      filtered = filtered.filter(email => {
        const emailFolder = email.folder?.toUpperCase() || '';
        const folderUpper = folder.toUpperCase();
        return emailFolder === folderUpper;
      });
    }
    ...
    switch (e.key) {
      ...
      case 'Enter':
        ...
        if (focusedIndex >= 0 && visibleEmails[focusedIndex]) {
          onEmailSelect?.(visibleEmails[focusedIndex]);
        }
        break;
      case 'a':
      case 'A':
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-12" role="status" aria-live="polite">
  ...
  if (visibleEmails.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-12 text-center" role="status">
  ...
  return (
    ...
    >
      {/* List Header */}
      <div className="flex-shrink-0 px-4 py-2 border-b border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800">
      ...
      >
        <ul className="divide-y divide-neutral-200 dark:divide-neutral-700" role="presentation">
      ...
      {/* List Footer */}
      <div className="flex-shrink-0 px-4 py-3 border-t border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 text-center">
